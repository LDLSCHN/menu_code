...
"code/Steer/Steer.src":"../code/Steer/Steer.c" "code/Steer/subdir.mk"
...
"code/Steer/Steer.o":"code/Steer/Steer.src" "code/Steer/subdir.mk"
	astc -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"

clean: clean-code-2f-Steer

clean-code-2f-Steer:
	-$(RM) ./code/Steer/Steer.d ./code/Steer/Steer.o ./code/Steer/Steer.src

.PHONY: clean-code-2f-Steer
