...
Sliding_Filter_t Motor_Speed_Filter = {0};
Sliding_Filter_t Camera_Cornering_MidErr_Sliding_Filter = {0};

float filter_camera_cornering_mid_err = 0;
...
* @brief : 低通滤波器初始化
* @param : filter            滤波器对象指针
* @param : alpha             滤波系数(0<alpha<=1)，越小滤波效果越弱
